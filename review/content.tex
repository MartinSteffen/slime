...
\begin{myslide}{Less good}
  \begin{itemize}
  \item \important{laaaate} first code delivery/compilation,
...
\begin{myslide}{next year}
  \begin{itemize}
  \item first \emph{Readme} \important{required} to be checked in after 2
    weeks.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% $Id: content.tex,v 1.15 2002-07-10 09:30:19 swprakt Exp $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Local Variables: 
%%% mode: latex
%%% TeX-master: "main"
