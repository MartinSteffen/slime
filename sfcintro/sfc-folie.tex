...
\usepackage{amsmath}
\usepackage{ks-foils, ks-symbols}
...
\begin{itemize}
\item SFC's: eine von mehreren standardisierten Beschreibungssprachen für
...
\item von vielen großen Firmen benutzt
...
Entwicklungsumgebung für SFC's, bestehend aus den Paketen
\begin{itemize}
