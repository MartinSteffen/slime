...
2002: Beginn ist der 10.\ April, Ende der 17.\ Juli. Das sind rechnerisch
\emph{14 Wochen.} Tabelle~\ref{tab:semesteruebersicht} stellt die geplanten
...
\begin{table}[htbp]
  \begin{center}
    \begin{tabular}{rrp{9cm}}
      ...
      \\
       & \textbf{18.\ Juli} & Abschluß, Review-Treffen, Schlußdemo
    \end{tabular}
...
sondern auch aus aktiver Projektteilnahme. Das beinhaltet insbesondere
...
Koordination einrichten. Die Addresse lautet
\begin{center}
