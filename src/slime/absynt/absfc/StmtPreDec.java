 ...
 * @version $Id: StmtPreDec.java,v 1.0 2002/06/12 19:53:45 mwe
 */


public class StmtPreDec extends Statement implements Serializable { 
  ...
  public StmtPreDec ( slime.absynt.Variable x ) {
    var        = x;
    nodetype   = "predec";
  }
