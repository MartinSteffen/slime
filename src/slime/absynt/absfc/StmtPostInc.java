 ...
 * @version $Id: StmtPostInc.java,v 1.0 2002/06/12 19:53:45 mwe
 */


public class StmtPostInc extends Statement implements Serializable { 
  ...
  public StmtPostInc ( slime.absynt.Variable x ) {
    var        = x;
    nodetype   = "postinc";
  }
