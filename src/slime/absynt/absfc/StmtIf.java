...
/**
 * Class for if-statements. An if-statements consists of an expression
 * and a stmtlist to be executed if expression is evaluated to true.
 *
 * @author initially provided by Marco Wendel.
 * @version $Id: StmtIf.java,v 1.0 2002/06/12 19:25:44 mwe
 */

public class StmtIf extends Statement implements Serializable { 
  ...
  public StmtIf (slime.absynt.Expr _expr, LinkedList _stmtlist, int _idepth) {
    expr = _expr;
    stmtlist = _stmtlist;
    ifdepth = _idepth;
    nodetype = "if";
  ...
  public StmtIf (slime.absynt.Expr _expr, LinkedList _stmtlist) {
    expr = _expr;
    stmtlist = _stmtlist;
    nodetype = "if";
  }
