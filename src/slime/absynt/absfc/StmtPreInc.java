 ...
 * @version $Id: StmtPreInc.java,v 1.0 2002/06/12 19:53:45 mwe
 */


public class StmtPreInc extends Statement implements Serializable { 
  ...
  public StmtPreInc ( slime.absynt.Variable x ) {
    var        = x;
    nodetype   = "preinc";
  }
