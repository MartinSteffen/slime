...
/**
 * Pretty printer for SFC's - modified
 * @author Initially provided by Karsten Stahl.
 * modified version Marco Wendel
 * @version $Id: PPActions.java,v 1.1 2002-07-02 13:32:20 swprakt Exp $
 */
...
public class PPActions {
    ...
    private PPActions(int i, int j, boolean _steps_long) {
...
// ---------------------------------------------------------------------------
	...
	PPActions prettyprint = new PPActions(column + tab, tab);
...
// ---------------------------------------------------------------------------
	...
	PPActions pp_long = new PPActions(column + tab, tab, true);
	...
	PPActions pp = new PPActions(column + tab, tab);
	PPActions prettyprint = new PPActions(column + 2*tab, tab);
	...
	for (Iterator i = action.sap.iterator(); i.hasNext();)
	    prettyprint.print((Absynt)i.next());
    }
...
//	--------------
//
//	$Id: PPActions.java,v 1.1 2002-07-02 13:32:20 swprakt Exp $
//
